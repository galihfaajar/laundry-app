...
export default function ChatScreen() {
  ...
  const activeQuickReplies = isAdmin
    ? adminQuickReplies
    : isCourier
      ? courierQuickReplies
      : laundryQuickReplies;
  ...
  const generateBotResponse = (text) => {
    ...
    if (isAdmin) {
      ...
      if (
        msg.includes("estimasi") ||
        msg.includes("waktu") ||
        msg.includes("lama") ||
        msg.includes("kapan selesai") ||
        msg.includes("pengerjaan")
      ) {
      ...
      if (
        msg.includes("cara pesan") ||
        msg.includes("pesan") ||
        msg.includes("order") ||
        msg.includes("gimana") ||
        msg.includes("bagaimana")
      ) {
      ...
      if (
        msg.includes("pembuat aplikasi") ||
        msg.includes("pembuat") ||
        msg.includes("siapa")
      ) {
        return "pembuat aplikasi ini adalah galih fajar";
      }
            ...
            <View>
              ...
              <View style={styles.statusRow}>
                <View
                  style={[
                    styles.onlineDot,
                    !person.online && { backgroundColor: Colors.textSecondary },
                  ]}
                />
                <Text
                  style={[
                    styles.onlineText,
                    !person.online && { color: Colors.textSecondary },
                  ]}
                >
